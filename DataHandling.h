...
struct UserFunc_t
{
    ErrorReturn_t (*func) (RunInstanceDataHandler_t*, Arg_t arg, void*);
    void* ptr;
    UserFunc_t (ErrorReturn_t (*f) (RunInstanceDataHandler_t*, Arg_t arg, void*) = nullptr, void* pt = nullptr) :
        func (f),
        ptr  (pt)
    {}

    ErrorReturn_t CallFunc (RunInstanceDataHandler_t* instance, Arg_t arg)
    {
        ErrorReturn_t ret (RET_SUCCESS);
        if (func) ret = func (instance, arg, ptr);
        return ret;
    }
};
...
public:
    ...
    ErrorReturn_t CallImportFunc (long long func, Arg_t arg)
    {
        return callImportFuncs_[func].CallFunc(this, arg);
    }
